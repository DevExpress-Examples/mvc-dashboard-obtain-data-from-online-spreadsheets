...
data.Add(new Invoices { Country = "Germany", City = "Cunewalde", ProductName = "Camembert Pierrot", OrderDate = GenerateOrderDate(), Quantity = 49, Discount = 0.25, ExtendedPrice = 1249.5, Freigth = 31.89, UnitPrice = 34 });
            ...
            data.Add(new Invoices { Country = "Germany", City = "K?ln", ProductName = "Camembert Pierrot", OrderDate = GenerateOrderDate(), Quantity = 30, Discount = 0, ExtendedPrice = 1020, Freigth = 145.63, UnitPrice = 34 });
            ...
            data.Add(new Invoices { Country = "Germany", City = "M?nchen", ProductName = "Raclette Courdavault", OrderDate = GenerateOrderDate(), Quantity = 70, Discount = 0.15, ExtendedPrice = 2618, Freigth = 208.58, UnitPrice = 44 });
            data.Add(new Invoices { Country = "Germany", City = "M?nchen", ProductName = "Raclette Courdavault", OrderDate = GenerateOrderDate(), Quantity = 30, Discount = 0, ExtendedPrice = 1320, Freigth = 4.93, UnitPrice = 44 });
            data.Add(new Invoices { Country = "Germany", City = "M?nchen", ProductName = "Camembert Pierrot", OrderDate = GenerateOrderDate(), Quantity = 20, Discount = 0.1, ExtendedPrice = 612, Freigth = 93.25, UnitPrice = 34 });
            data.Add(new Invoices { Country = "Germany", City = "M?nchen", ProductName = "Camembert Pierrot", OrderDate = GenerateOrderDate(), Quantity = 36, Discount = 0.05, ExtendedPrice = 1162.8, Freigth = 242.95, UnitPrice = 34 });
